...
$lang['legend:linking']        = 'Ссылки';
$lang['legend:caching']        = 'Кэширование';
$lang['label:default linking'] = 'По умолчанию';
$lang['label:direct linking']  = 'Прямая ссылка';
...
$lang['js']['label:bulletList'] = 'Маркированный список';
$lang['js']['label:code']      = 'Блок кода';
...
$lang['js']['label:liftLI']    = 'Поднять элемент списка';
$lang['js']['label:link']      = 'Вставить ссылку';
$lang['js']['label:orderedList'] = 'Нумерованный список';
$lang['js']['label:paragraph'] = 'Параграф';
$lang['js']['label:pluginBlock'] = 'Блок плагина';
...
$lang['js']['label:sinkListItem'] = 'Понизить элемент списка';
$lang['js']['label:marks']     = 'Форматирование';
$lang['js']['label:strong']    = 'жирный';
...
$lang['js']['label:deleted']   = 'зачёркнутый';
...
$lang['js']['label:rss date']  = 'Показать дату публикации';
$lang['js']['label:rss details'] = 'Показать описание записи';
$lang['js']['label:rss refresh'] = 'Период обновления';
$lang['js']['code_block_hint'] = 'Нажмите CTRL+Enter для выхода';

$lang['legend:link type'] = 'Тип ссылки';
$lang['legend:link name type'] = 'Тип названия ссылки';
$lang['label:link name input'] = 'Название ссылки';
$lang['btn:ok'] = 'ОК';
